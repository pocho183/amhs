...
| SA-01 | Security assurance pack | Are PKI, labels, and negotiation controls declared with transition-governed, profile-limited claim wording and evidence? | `docs/icao/ATN_PKI_SECURITY_LABEL_EVIDENCE.md`; `docs/icao/PKI_LIFECYCLE_GOVERNANCE_CONTROLS.md`; `docs/icao/ACSE_PRESENTATION_NEGOTIATION_MATRIX.md`; `docs/icao/releases/R2026.03/evidence/security-pki-label/README.md`; `docs/icao/releases/R2026.03/evidence/p3-multi-vendor/latest-manifest.txt`. |
