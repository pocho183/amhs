...
| ATN-AMHS-P1-EXT-01 | P1 extension handling shall be frozen with deterministic known/unknown behavior, declared criticality posture, and backward/forward compatibility checks including operational legacy vectors. | `src/main/java/it/amhs/service/protocol/p1/P1AssociationProtocol.java`, `src/main/java/it/amhs/service/protocol/p1/P1BerMessageParser.java`, `src/main/java/it/amhs/service/protocol/p1/X411TagMap.java` | `src/test/java/it/amhs/service/P1AssociationProtocolTest.java`, `src/test/java/it/amhs/service/P1BerMessageParserTest.java`, `docs/icao/P1_EXTENSION_HANDLING_POLICY.md`, `docs/icao/P1_LEGACY_ENCODING_REGRESSION_VECTORS.md` | Pass |
