...
| 7. P3 bind/submit/status/report/release multi-vendor reproducibility with negative diagnostics | `docs/icao/MULTI_VENDOR_BIND_SUBMIT_STATUS_REPORT_RELEASE_EVIDENCE.md`, `scripts/evidence/p3_multi_vendor_evidence.sh`, `scripts/evidence/decode_campaign_pcap.py`, `src/test/java/it/amhs/service/protocol/p3/P3Asn1GatewayProtocolTest.java`, `src/test/java/it/amhs/service/protocol/p3/P3GatewaySessionServiceTest.java`, `src/test/java/it/amhs/service/protocol/p3/P3Asn1GatewayProtocolNegativeVectorsTest.java`, release artifacts under `docs/icao/releases/R2026.03/evidence/p3-multi-vendor/` including signed campaign report, decoded trace, and verdict ledger. |
