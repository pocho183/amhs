...
public class X411DeliveryReportApduCodec {
    ...
    public record ReportedRecipientInfo(String recipient, String deliveryStatus, Integer diagnosticCode) {
        public ReportedRecipientInfo(String recipient, String deliveryStatus, int diagnosticCode) {
            this(recipient, deliveryStatus, Integer.valueOf(diagnosticCode));
        }

        public ReportedRecipientInfo(String recipient, String deliveryStatus, String diagnosticCode) {
            this(recipient, deliveryStatus, parseDiagnosticCode(diagnosticCode));
        }
